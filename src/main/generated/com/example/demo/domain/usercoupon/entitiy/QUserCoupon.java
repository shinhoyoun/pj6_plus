...
public class QUserCoupon extends EntityPathBase<UserCoupon> {
    ...
    private static final long serialVersionUID = 782994438L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QUserCoupon userCoupon = new QUserCoupon("userCoupon");

    public final com.example.demo.domain.coupon.entity.QCoupon coupon;
    ...
    public QUserCoupon(Class<? extends UserCoupon> type, PathMetadata metadata, PathInits inits) {
        ...
        this.coupon = inits.isInitialized("coupon") ? new com.example.demo.domain.coupon.entity.QCoupon(forProperty("coupon"), inits.get("coupon")) : null;
